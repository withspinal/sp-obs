...
class TestPerplexityProvider:
    ...
    def sample_response_attributes(self) -> Dict[str, Any]:
        """Provide sample Perplexity response attributes from an actual span (attributes only)."""
        return {
    ...
    def test_provider_identification(self, sample_response_attributes):
        ...
        # Verify it's the PerplexityProvider provider
        from sp_obs._internal.core.providers.perplexity import PerplexityProvider

        assert isinstance(provider, PerplexityProvider), f"Expected PerplexityProvider instance, got {type(provider)}"
